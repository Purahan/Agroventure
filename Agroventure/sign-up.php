...
if(!empty($_POST)) {
	...
	if ($conn->connect_error) {
		...
		$sql = "INSERT INTO `users` (first_name, last_name, email, pwd, phone, gender, dob, user_type, created_on) VALUES ('".$_POST['fname']."', '".$_POST['lname']."', '".$_POST['email']."', '".md5($_POST['pwd'])."', '".$_POST['phone']."', '".$_POST['gender']."', '".$_POST['dob']."', 'buyer', '".date("Y-m-d")."')";
    ...
    <body style="background-color: rgb(187, 203, 161); font-family: Arial, Helvetica, sans-serif;">
        <div id="header">
            <header class="d-flex flex-wrap justify-content-center px-3 py-3 mb-4 border-bottom bg-light">
                ...
                <li class="nav-item"><a href="sign-in.php" class="nav-link">Login</a></li>
                <li class="nav-item"><a href="sign-up.php" class="nav-link active">Sign Up</a></li>
                </ul>
            </header>
        </div>
        <form action="sign-up.php" method="post" onsubmit="return checkForm();">
            <div class="container bg-light my-5 py-4 px-5">
                ...
                <a href=""></a><input type="submit" class="btn btn-success w-100 px-2 py-2 fs-5" value="Register" />
                <p>Already have an account? <a href="Sign-in.html">Sign in</a>.</p>
            </div>
        </form>
        <script src="seller/sign-up.js"></script>
    </body>
</html>
